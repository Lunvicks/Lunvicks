...
## <img src="./mario.png" alt="Mario Tanooki Pixel Art" width="100">SOBRE MIM
...
- 📌 Evoluir em SQL e modelagem de dados  
- 📌 Criar portfólio de dashboards  
- 📌 Desenvolver automações em Python  
